...
__scriptid__ = 'plugin.video.ceknito.sk'
__scriptname__ = 'ceknito.sk'
...
class CeknitoXBMCContentProvider(xbmcprovider.XBMCMultiResolverContentProvider):
    def play(self, item):
...
CeknitoXBMCContentProvider(ceknito.CeknitoContentProvider(tmp_dir=xbmcvfs.translatePath(__addon__.getAddonInfo('profile'))), settings, __addon__).run(params)
